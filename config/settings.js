...
const settings = {
    ...
    llm: {
        ...
        plannerMaxInputTokens: llamaNumberFromEnv('LLM_PLANNER_MAX_INPUT_TOKENS', 5000),
        plannerRetryInputTokens: llamaNumberFromEnv('LLM_PLANNER_RETRY_INPUT_TOKENS', 3200),
        plannerTokenEstimateMultiplier: llamaNumberFromEnv('LLM_PLANNER_TOKEN_ESTIMATE_MULTIPLIER', 1.35),
        ...
        contextTokenBudget: llamaNumberFromEnv('LLM_CONTEXT_TOKEN_BUDGET', 4500),
        responseContextTokenBudget: numberFromEnv('LLM_RESPONSE_CONTEXT_TOKEN_BUDGET', 1200),
        maxContextMessages: llamaNumberFromEnv('LLM_MAX_CONTEXT_MESSAGES', 24),
        maxContextPolls: numberFromEnv('LLM_MAX_CONTEXT_POLLS', 10),
        tokensPerMinute: llamaNumberFromEnv('LLM_TOKENS_PER_MINUTE', 30000),
        requestsPerMinute: llamaNumberFromEnv('LLM_REQUESTS_PER_MINUTE', 30),
        plannerTokensPerMinute: llamaNumberFromEnv('LLM_PLANNER_TOKENS_PER_MINUTE', 30000),
        plannerRequestsPerMinute: llamaNumberFromEnv('LLM_PLANNER_REQUESTS_PER_MINUTE', 30),
