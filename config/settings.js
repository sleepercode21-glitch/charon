...
const settings = {
    ...
    llm: {
        ...
        plannerMaxInputTokens: numberFromEnv('LLM_PLANNER_MAX_INPUT_TOKENS', 2000),
        plannerRetryInputTokens: numberFromEnv('LLM_PLANNER_RETRY_INPUT_TOKENS', 1900),
        plannerTokenEstimateMultiplier: numberFromEnv('LLM_PLANNER_TOKEN_ESTIMATE_MULTIPLIER', 2.5),
        plannerMinRequestTokens: numberFromEnv('LLM_PLANNER_MIN_REQUEST_TOKENS', 6500),
        plannerMinRequestIntervalMs: numberFromEnv('LLM_PLANNER_MIN_REQUEST_INTERVAL_MS', 20000),
        ...
        plannerTokensPerMinute: numberFromEnv('LLM_PLANNER_TOKENS_PER_MINUTE', 30000),
        plannerRequestsPerMinute: numberFromEnv('LLM_PLANNER_REQUESTS_PER_MINUTE', 3),
