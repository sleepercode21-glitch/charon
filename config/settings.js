...
const settings = {
    ...
    llm: {
        ...
        situationMaxOutputTokens: numberFromEnv('LLM_SITUATION_MAX_OUTPUT_TOKENS', 160),
        planMaxOutputTokens: numberFromEnv('LLM_PLAN_MAX_OUTPUT_TOKENS', 220),
        responseMaxOutputTokens: numberFromEnv('LLM_RESPONSE_MAX_OUTPUT_TOKENS', 220),
        maxInputTokens: numberFromEnv('LLM_MAX_INPUT_TOKENS', 4500),
        contextTokenBudget: numberFromEnv('LLM_CONTEXT_TOKEN_BUDGET', 1800),
        situationContextTokenBudget: numberFromEnv('LLM_SITUATION_CONTEXT_TOKEN_BUDGET', 550),
        maxContextMessages: numberFromEnv('LLM_MAX_CONTEXT_MESSAGES', 16),
        maxContextPolls: numberFromEnv('LLM_MAX_CONTEXT_POLLS', 5),
        ...
        decisionGapMs: numberFromEnv('LLM_DECISION_GAP_MS', 18000),
        maxDbToolSteps: numberFromEnv('LLM_MAX_DB_TOOL_STEPS', 1),
